...
const Home = (props) => {
  ...
  return (
    <div className="container-fluid resp bg-dark text-light">
      <div className="container">
        <img  className="img-style fade-in-profile" src={profile} alt="profile" />
        ...
        <div className="my-4">
          ...
          <a href="MyCv.pdf" download="Asma.pdf">
            <button type="button" class="btn btn-warning mx-1 " onClick={Resume}>
             Get Resume
            </button>
          </a>
        </div>
